...
def intro():
	...
	while intro:
		...
		for x in range(20):
			#x325
			for y in range(20):
				pygame.draw.circle(screen,(255,255,0),(3*x*count,3*y*count),count)
				pygame.draw.circle(screen,(255,0,0),(2*x*count, 2*y*count),count)
...
if __name__ == "__main__":
	...
	while gameRule:
		...
		board = Board()
		player1 = Entity(200,650,3)
		player2 = Entity(200,100,1)
		game = True
		count = 0
		maps = []
		nextFrame = clock()
